...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            ...
            <span class="navbar-text">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  @if (session('uid'))
                  <li class="nav-item">
                    <a class="nav-link" href="{{ session('uid') }}/list"><b>MyList</b></a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="container">
        <br><br>
        <h1 class="display-1 text-center">PanaromicPopcorn</h1>
        <br><br>
        <form class="text-center" method=get action="search">
          
            <div class="mb-3">

              <input placeholder="Search for movies" name='q' type="text" class="form-control form-control-lg " id="q" >
            </div>
            <br>
